...
DECLARE @temp_temp3 nvarchar(2000)
DECLARE @Priority nvarchar(2000)
DECLARE @sql_status nvarchar(2000)
DECLARE @sql_status_value nvarchar(2000)
...
ST_RUN_NAME  varchar(2000),
ST_STATUS varchar(2000),
ST_EXECUTION_DATE varchar(2000),
ST_EXECUTION_TIME varchar(2000),
ST_DESCRIPTION varchar(2000),
ST_EXPECTED varchar(2000),
ST_Priority varchar(2000) default 0
)
--------###tmp_f_3过滤完成的数据用例
