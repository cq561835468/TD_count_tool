...
begin
	...
	begin
		...
		from ##tmp_f_5 where ST_TEST_ID =@temp_temp and ST_STEP_ID = @temp_temp2 order by ST_number_f_p DESC,ST_EXECUTION_DATE DESC,ST_EXECUTION_TIME DESC
		fetch next from bbb into @temp_temp2
	end
	Close bbb    
	Deallocate bbb 
