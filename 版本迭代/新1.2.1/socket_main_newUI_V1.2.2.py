...
class aboutUI(wx.Frame):
    def __init__(self):
        ...
        self.stat7=wx.StaticText(self.panel,-1,"  版本: 1.2.2.20150818",(80,80))
...
class DemoFrame(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, -1, 'TD系统数据统计分析工具1.2',pos=(500, 50),size=(600, 500),style=wx.DEFAULT_FRAME_STYLE ^(wx.RESIZE_BORDER | wx.MAXIMIZE_BOX))
