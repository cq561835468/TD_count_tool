...
class TDapp(wx.Panel):
    def __init__(self,parent):
        ...
        self.ip = wx.TextCtrl(self, -1, "172.16.121.1", pos=(30,40),size=(120, -1))
...
class  TDthird(wx.Panel): #功能2
    def __init__(self,parent):
        ...
        self.tree = wx.TreeCtrl(self,pos=(50, 190),size=(220,140))                      #测试项
        self.listBox3 = wx.ListBox (self, -1, (290, 190), (260, 140), sampleList,wx.LB_EXTENDED)                #测试点
        self.button1 = wx.Button(self, -1, "导出excel", pos=(250, 370))
        self.Bind(wx.EVT_PAINT,  self.autologin)  
        self.Bind(wx.EVT_LISTBOX,  self.timeget, self.listBox1)
        #--------------------树控件     
        self.Bind(wx.EVT_TREE_SEL_CHANGED, self.sectimeget, self.tree)     
    ...
    def  sectimeget(self, event):#listbox2事件
        #try:
            #self.listBox3.Clear()
            self.listBox3.Append("123123")     
            #f =self.listBox2.GetSelection()#获取当前选择的顶级项目号
...
class aboutUI(wx.Frame):
    def __init__(self):
        ...
        self.stat7=wx.StaticText(self.panel,-1,"  版本: 1.5.0.20160225",(80,80))
...
class DemoFrame(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, -1, 'TD系统数据统计分析工具1.5.0',pos=(500, 50),size=(600, 500),style=wx.DEFAULT_FRAME_STYLE ^(wx.RESIZE_BORDER | wx.MAXIMIZE_BOX))
